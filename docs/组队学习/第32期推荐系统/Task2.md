...
6. 使用 (<) 和 (>) 查询 - \$lt 和 \$gt：`db.col.find({likes : {$lt :200, $gt : 100}})`
...
![image-20211216230529614](img/Task02%20数据库的基本使用/image-20211216230529614-9667131-9708588.png)
...
![image-20211217093227085](img/Task02%20数据库的基本使用/image-20211217093227085-9704748.png)



* 当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户 端:

![image-20211217093125773](img/Task02%20数据库的基本使用/image-20211217093125773-9704687.png)

* 应用：广泛用于构建即时通信应用，比如网络聊天室(chatroom)和实时广播、实时提醒等

![image-20211217093032988](img/Task02%20数据库的基本使用/image-20211217093032988-9704634.png)
