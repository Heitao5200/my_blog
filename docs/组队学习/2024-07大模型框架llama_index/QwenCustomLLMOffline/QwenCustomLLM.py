...
class QwenCustomLLM(CustomLLM):
    ...
    def __init__(self, pretrained_model_name_or_path):
        ...
        # GPU方式加载模型
        self.tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path, device_map="auto", trust_remote_code=True)
        self.model = AutoModelForCausalLM.from_pretrained(pretrained_model_name_or_path, device_map="auto", trust_remote_code=True).eval()
...
if __name__ == "__main__":
    ...
    pretrained_model_name_or_path = r'/Users/heitao/my_blog/models/qwen/Qwen1_5-0_5B-Chat'
    llm = QwenCustomLLM(pretrained_model_name_or_path)


    # 定义你的服务上下文
    service_context = ServiceContext.from_defaults(
        llm=llm, embed_model="local:/Users/heitao/my_blog/models/AI-ModelScope/bge-base-zh-v1___5"
    )
