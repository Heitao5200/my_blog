...
| N vs 1   | ![](img/第六章_循环神经网络(RNN)/6.8.jpg) | 1、输出一段文字，判断其所属类别<br />2、输入一个句子，判断其情感倾向<br />3、输入一段视频，判断其所属类别 |
...
![](img/第六章_循环神经网络(RNN)/figure_6.4_1.png)
...
![](img/第六章_循环神经网络(RNN)/figure_6.6.5_1.png)
...
![](img/第六章_循环神经网络(RNN)/figure_6.6.7_1.png)
